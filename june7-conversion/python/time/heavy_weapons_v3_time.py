"""Python is a Python time-based — Heavy Weapons Single v3 fire-matrix on time bars.
...
Source: ".../June 7/Tick Friendly conversion/heavy weapons v3_tickfriendly.pine"
        ...
        wrapper (_heavy_weapons_v3_core). Every one of the 44 detection plots is
        produced from OHLCV; there is NO stub engine layer.
...
def run_on_rows(rows, *, params: Params | None = None, tf_seconds: int = 60):
    """rows: (ts_ms, o, h, l, c, v) oldest-first. -> 44-plot fire matrix + levels."""
...
if __name__ == "__main__":
    ...
    print("Python is a Python time-based — Heavy Weapons Single v3 (FULL port)")
