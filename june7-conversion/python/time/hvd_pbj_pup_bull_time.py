...
"""BASE HV+D <-> PBJ <-> PPD v1 — BULLISH (38) -> Python (TIME grain). FULL port.
...
day). The time module and the tick module (../tick/hvd_pbj_pup_bull_tick.py) share
...
if __name__ == "__main__":
    ...
    print("Python is a Python time-based — hvd_pbj_pup_bull (FULL port, 38 plots)")
