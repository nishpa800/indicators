# First Bar Fable Displacement 5

Variant of [First Bar Fable v2](../first-bar-fable/) with the **"Displacement 9" engine
default σ-multiplier = 5** (the input stays adjustable on the chart). Everything else is
...
- **Current version: v1** — `versions/FIRST_BAR_FABLE_DISPLACEMENT_5_v1.pine`
- Chart title `First Bar Fable Displacement 5`, shorttitle `1st BAR FABLE D5`.
...
Raw code (copy-paste):
<https://raw.githubusercontent.com/nishpa800/indicators/claude/first-bar-fable-indicator-eorleb/first-bar-fable-displacement-5/versions/FIRST_BAR_FABLE_DISPLACEMENT_5_v1.pine>

Or locally: `pbcopy < first-bar-fable-displacement-5/versions/FIRST_BAR_FABLE_DISPLACEMENT_5_v1.pine`
